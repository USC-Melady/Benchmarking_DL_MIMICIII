...
DROP MATERIALIZED VIEW IF EXISTS vent2day CASCADE;
CREATE MATERIALIZED VIEW vent2day AS
select
...
--     OR (vd.starttime >= ie.intime and vd.starttime <= ie.intime + interval '1' day)
    OR (vd.starttime >= ie.intime and vd.starttime <= ie.intime + interval '2' day)
  )
