...
-- The score is calculated on the 2 day of each ICU patients' stay.
-- ------------------------------------------------------------------
...
--  1) uo2day - generated by urine-output-2-day.sql
--  2) vitals2day - generated by vitals-2-day.sql
--  3) gcs2day - generated by gcs-2-day.sql
--  4) labs2day - generated by labs-2-day.sql
--  5) bloodgas2dayarterial - generated by blood-gas-2-day-arterial.sql
...
DROP MATERIALIZED VIEW IF EXISTS SOFA_48 CASCADE;
CREATE MATERIALIZED VIEW SOFA_48 AS
with wt AS
(
...
left join vitals2day v
  on ie.icustay_id = v.icustay_id
left join labs2day l
