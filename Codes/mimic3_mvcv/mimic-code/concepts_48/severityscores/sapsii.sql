...
--  3) vitals2day - generated by vitals-2-day.sql
--  4) gcs2day - generated by gcs-2-day.sql
--  5) labs2day - generated by labs-2-day.sql

-- Note:
--  The score is calculated for *all* ICU patients, with the assumption that the user will subselect appropriate ICUSTAY_IDs.
--  For example, the score is calculated for neonates, but it is likely inappropriate to actually use the score values for these patients.

DROP MATERIALIZED VIEW IF EXISTS SAPSII_48 CASCADE;
CREATE MATERIALIZED VIEW SAPSII_48 as
