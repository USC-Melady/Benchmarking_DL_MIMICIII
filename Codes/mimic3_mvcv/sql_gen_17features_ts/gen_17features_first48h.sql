DROP MATERIALIZED VIEW IF EXISTS mengcz_17features_first48h CASCADE;
CREATE MATERIALIZED VIEW mengcz_17features_first48h AS
with cpap as
(
...
left join gcs2day gcs
  on ie.icustay_id = gcs.icustay_id
left join vitals2day vital
  on ie.icustay_id = vital.icustay_id
left join uo2day uo
  on ie.icustay_id = uo.icustay_id
left join labs2day labs
